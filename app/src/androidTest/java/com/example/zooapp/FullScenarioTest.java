...
public class FullScenarioTest {
    ...
    public void fullScenarioTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.directions_header), withText("Alligators"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(android.R.id.message), withText("The Route is Completed"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.ScrollView.class))),
                        isDisplayed()));
        textView3.check(matches(withText("The Route is Completed")));
